...
class ProductDetailCombo extends StatefulWidget {
  final String? productId;
  final String? slug;
  ProductDetailCombo({Key? key, this.productId, this.slug}) : super(key: key);

  @override
  _ProductDetailStateCombo createState() => _ProductDetailStateCombo();
}

class _ProductDetailStateCombo extends State<ProductDetailCombo>
  ...
  Widget firstPart(Combo model, Widget btnFav) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            productModel!.vouchers != null ? 'Còn hàng' : 'Hết hàng',
            style: TextStyle(
                fontSize: responsiveFont(11),
                fontWeight: FontWeight.bold,
                color:
                    productModel!.vouchers != null ? Colors.green : Colors.red),
          ),
          SizedBox(
            height: 10,
          ),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => ProductDetailCombo()));
      },
      child: Container(
