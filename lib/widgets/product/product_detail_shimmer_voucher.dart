...
class ProductDetailShimmerVoucher extends StatefulWidget {
  ProductDetailShimmerVoucher({Key? key}) : super(key: key);

  @override
  _ProductDetailShimmerVoucherState createState() =>
      _ProductDetailShimmerVoucherState();
}

class _ProductDetailShimmerVoucherState
    extends State<ProductDetailShimmerVoucher> with TickerProviderStateMixin {
